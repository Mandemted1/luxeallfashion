...
// Promo image inset with the same side margins as CollectionTile, with a
// solid CTA button overlaid near the bottom. imageSrc is optional so the
// layout is verifiable before real photography is supplied — swap in a src
...
export function FullBleedBanner({
  ...
  return (
    <section className="w-full px-4 py-8 sm:py-10">
      <div className="relative aspect-[16/10] w-full overflow-hidden bg-stone-100 sm:aspect-[8/5]">
        {imageSrc ? (
          <Image
            src={imageSrc}
            alt={imageAlt ?? ""}

...
// all strip or mangle <style> blocks and modern CSS differently). Kept in
// sync with apps/storefront/src/lib/email-template.ts by hand — the two
// apps don't share a package for this.
